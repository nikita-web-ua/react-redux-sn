...
type setNewCaptchaUrlActionType = {
    type: typeof SET_NEW_CAPTCHA_URL,
    payload: {captchaUrl: string }
}
const setNewCaptchaUrl = (captchaUrl: string):setNewCaptchaUrlActionType => ({type: SET_NEW_CAPTCHA_URL, payload: {captchaUrl}})
